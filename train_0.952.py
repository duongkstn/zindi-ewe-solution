...
def get_model(dls):
    # Using mobilenet v2
    model = mobilenet_v2(pretrained=False, num_classes=dls.c)
    return model
...
if __name__ == "__main__":
    ...
    df_test.to_csv("result/Submission_cnn_0.952.csv", index=False)

    learn.export('saved_model/model_0.952.pkl')
